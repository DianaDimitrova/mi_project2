...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.ðšð°ñ‚ð°ð»ð¾ð³.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('discription', old('discription'), array('class'=>'form-control')) !!}
